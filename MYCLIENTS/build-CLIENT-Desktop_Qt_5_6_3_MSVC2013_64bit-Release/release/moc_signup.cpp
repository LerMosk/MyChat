...
QT_MOC_LITERAL(1, 7, 9), // "trySignUp"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 11), // "closeSignUp"
QT_MOC_LITERAL(4, 30, 9), // "goToLogin"
QT_MOC_LITERAL(5, 40, 11), // "slotChecked"
QT_MOC_LITERAL(6, 52, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(7, 74, 23) // "on_pushButton_2_clicked"

    },
    "SignUp\0trySignUp\0\0closeSignUp\0goToLogin\0"
    "slotChecked\0on_pushButton_clicked\0"
...
void SignUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->trySignUp((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->closeSignUp(); break;
        case 2: _t->goToLogin(); break;
        case 3: _t->slotChecked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            typedef void (SignUp::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SignUp::trySignUp)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SignUp::closeSignUp)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SignUp::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SignUp::goToLogin)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SignUp::trySignUp(const QString & _t1, const QString & _t2)
{
